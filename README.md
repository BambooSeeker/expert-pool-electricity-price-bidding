...
This repository accompanies the manuscript submitted to IEEE Transactions on Smart Grid. It provides a reproducible seven-day demonstration of the published forecast-to-bid workflow for a Zhejiang day-ahead electricity-market case.
...
Please cite the accompanying paper and this repository. The repository DOI will be added to `CITATION.cff` when the archived release is issued.
